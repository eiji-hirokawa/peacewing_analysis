...
-- 日付の指定
set date_2023 = "2023-03-25";
set date_2024 = "2024-03-23";

CREATE OR REPLACE TABLE `prd-analysis.w_e_hirokawa.compare_edion_and_peacewing_not_match_day_saturday` AS

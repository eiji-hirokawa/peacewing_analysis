...
-- テーブルの作成
CREATE OR REPLACE TABLE `prd-analysis.w_e_hirokawa.role_playing_shonan_hashed_adid_count` AS
...
with tmp as (
  ...
  where
    ...
    date(sdk_detect_ptime, 'Asia/Tokyo') between "2024-03-01" and "2024-04-30" and
    (
...
from
  tmp
group by date(sdk_detect_ptime, 'Asia/Tokyo')
order by date
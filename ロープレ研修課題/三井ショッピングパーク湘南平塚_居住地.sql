-- テーブルの作成
CREATE OR REPLACE TABLE `prd-analysis.w_e_hirokawa.role_playing_shonan_mitsui_hashed_adid_poi_home` AS
...
SELECT
  ...
  poi_home_mesh_lon
FROM
  `prd-analysis.w_e_hirokawa.role_playing_shonan_mitsui`
where
